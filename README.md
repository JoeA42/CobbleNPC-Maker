...
python main.py
**CobbleNPC Maker** is a great name! It clearly communicates what the tool does (makes NPCs for Cobblemon) and is simple and memorable.

Let's rename the project:

```bash
cd ~/Documents
mv "Trainer Generator" CobbleNPC-Maker
cd CobbleNPC-Maker
```

Now update the README with the new name and focus:
