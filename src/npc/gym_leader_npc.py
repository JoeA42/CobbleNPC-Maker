...
def generate_gym_leader_snbt(leader_id, leader_info, template_dir="SNBT Templates", output_dir="npcs/gym_leaders"):
    ...
    victory_first_dialog_1 = get_gym_dialog(leader_id, "victory_first_1")
    victory_first_dialog_2 = get_gym_dialog(leader_id, "victory_first_2")
    ...
    content = content.replace("${victory_first_dialog_1}", victory_first_dialog_1)
    content = content.replace("${victory_first_dialog_2}", victory_first_dialog_2)
...
def generate_all_gym_leaders(template_dir="SNBT Templates", output_dir="npcs/gym_leaders"):
